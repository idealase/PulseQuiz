  ...
  return (
    <div className="min-h-[100dvh] px-4 pt-16 pb-6 sm:px-6 sm:pt-16 sm:pb-6 max-w-lg mx-auto">
      <div className="mb-8">
        <button
          onClick={handleBack}
          className="inline-flex items-center gap-2 text-white/70 hover:text-white transition-colors mb-4 border-2 border-transparent hover:border-white/30 rounded px-2 py-1"
        >
      ...
      <div className="space-y-4">
        <div className="rounded-lg bg-transparent border-2 border-white/30 px-4 py-4">
          <div className="mb-3">
        ...
        <label className="flex items-center justify-between rounded-lg bg-transparent border-2 border-white/30 px-4 py-4">
          <div>
        ...
        <label className="flex items-center justify-between rounded-lg bg-transparent border-2 border-white/30 px-4 py-4">
          ...
          <select
            ...
            className="bg-transparent border-2 border-white/30 rounded-lg px-3 py-2 text-sm"
          >
